    ...
    <el-row :gutter='0'>
      ...
      <el-col :xl='16'>
        <el-menu
          ...
          <el-menu-item index='3' route='/b/talk' class='hidden-mobile' @click='forceUpdate'>토크</el-menu-item>
          <el-menu-item index='4' route='/b/feedback' class='hidden-mobile' @click='forceUpdate'>건의</el-menu-item>
